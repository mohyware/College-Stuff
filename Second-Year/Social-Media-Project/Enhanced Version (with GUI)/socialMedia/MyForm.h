...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox2->Location = System::Drawing::Point(26, 230);
			...
			this->button2->Location = System::Drawing::Point(153, 306);
			...
			this->label3->Location = System::Drawing::Point(19, 43);
			...
			this->panel1->Location = System::Drawing::Point(26, 258);
			...
			this->panel2->Location = System::Drawing::Point(26, 178);
			...
			this->textBox3->Location = System::Drawing::Point(26, 150);
			...
			this->checkBox1->Location = System::Drawing::Point(26, 368);
			...
			this->label4->Location = System::Drawing::Point(138, 369);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	username = toStandardString(textBox3->Text);
	pass = toStandardString(textBox2->Text);

	std::ofstream myFIle("loginUsers.txt");
	myFIle << username << "\n" << pass ;
	myFIle.close();
...
private: System::Void textBox3_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	std::string st = toStandardString(textBox2->Text);
	std::string st2 = toStandardString(textBox3->Text);

	if (!IsNullOrWhiteSpace(st) && !IsNullOrWhiteSpace(st2))
	{
		button1->Enabled = true;
	}
	else {
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (panel1->Controls->Contains(label1) && panel1->Controls->Contains(textBox3)) {
		// If label1 is currently visible, hide it and show label2
		...
		// If label2 is currently visible (or hidden), switch back to label1
		label1->Visible = true;
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	if (panel1->Controls->Contains(label2)) {
		// If label1 is currently visible, hide it and show label2
		label2->Visible = false;
		label1->Visible = true;
	}
